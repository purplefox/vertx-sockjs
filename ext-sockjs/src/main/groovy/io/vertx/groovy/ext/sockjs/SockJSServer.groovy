...
public class SockJSServer {
  ...
  public SockJSServer installApp(Map<String, Object> options = [:], Handler<SockJSSocket> sockHandler) {
    this.delegate.installApp(options != null ? io.vertx.ext.sockjs.SockJSServerOptions.optionsFromJson(new io.vertx.core.json.JsonObject(options)) : null, new Handler<io.vertx.ext.sockjs.SockJSSocket>() {
  ...
  public SockJSServer bridge(Map<String, Object> options = [:], Map<String, Object> bridgeOptions = [:]) {
    this.delegate.bridge(options != null ? io.vertx.ext.sockjs.SockJSServerOptions.optionsFromJson(new io.vertx.core.json.JsonObject(options)) : null, bridgeOptions != null ? io.vertx.ext.sockjs.BridgeOptions.optionsFromJson(new io.vertx.core.json.JsonObject(bridgeOptions)) : null);
    return this;
  }
  public void close() {
    this.delegate.close();
